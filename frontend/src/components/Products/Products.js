      ...
      <div className="max-w-6xl mx-auto">
        <form className="max-w-sm mx-auto my-4">
          <div className="relative">
            ...
            <input type="search" id="default-search" className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-orange-500 focus:border-orange-500" placeholder="Search Products" />
